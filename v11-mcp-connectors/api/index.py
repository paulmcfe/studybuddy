"""StudyBuddy v11 - MCP Connectors API
...
# Create FastAPI app
app = FastAPI(
    title="StudyBuddy v11",
    description="Full-stack learning application with AI-powered tutoring and MCP connectors",
    version="11.0.0",
)
...
async def chat_with_tutor(
    ...
    if brave_api_key:
        return await _chat_with_agent(program, request, context, brave_api_key)
