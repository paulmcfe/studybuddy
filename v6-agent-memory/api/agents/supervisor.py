...
tutoring, card generation, quality checking, and spaced repetition.

v6 additions: Scheduler agent for spaced repetition
"""
...
4. Direct response: Simple greetings, clarifications, or meta-questions
...
def route_request(
    ...
    try:
        ...
        # Validate next_agent (v6: added scheduler)
