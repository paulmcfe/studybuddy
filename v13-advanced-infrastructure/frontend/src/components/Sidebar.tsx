...
type View = 'overview' | 'study' | 'flashcards' | 'documents' | 'connectors' | 'new-program' | 'models' | 'costs' | 'benchmarks'
    ...
    return (
        <aside className="sidebar">
            <div className="sidebar-header">
                ...
                <span className="sidebar-version">v13 - Advanced Infrastructure</span>
            </div>
