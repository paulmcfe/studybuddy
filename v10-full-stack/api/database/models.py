"""SQLAlchemy models for StudyBuddy v10.

v10 introduces Learning Programs - containers for subject-specific learning.
...
The v9 Curriculum system is replaced by Learning Programs.
"""
...
class User(Base):
    ...
    In v10, users are scoped but authentication is deferred to Chapter 12.
    For now, user_id is passed through but not validated.

    Note: This model matches the existing v9 users table schema.
    The email column will be added in Chapter 12 when auth is implemented.
    """
