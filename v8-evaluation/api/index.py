...
- Custom evaluators for tutoring, flashcard, and retrieval quality
- Baseline evaluation runner
- Evaluation dashboard with metrics, trends, and recommendations
"""
...
os.environ["LANGSMITH_PROJECT"] = "studybuddy-v8"
