"""SQLAlchemy models for StudyBuddy v9 persistence.
...
- EvaluationRun: Track evaluation experiments and metrics
"""
...
# ============== v8: Evaluation Infrastructure Models ==============


class EvaluationRun(Base):
    """Track evaluation runs for historical analysis.

    Stores results from running evaluation suites against the system,
    enabling tracking of quality metrics over time.
    """
    ...
    dataset_type = Column(String(50), nullable=False)  # tutoring, flashcard, retrieval
