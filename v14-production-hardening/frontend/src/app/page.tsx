...
export default function Home() {
    ...
    const renderContent = () => {
        // v13/v14 infrastructure views — accessible without a selected program
        if (view === 'models') return <ModelSettings />
        if (view === 'costs') return <CostDashboard />
        if (view === 'benchmarks') return <BenchmarkResults />
        if (view === 'cost-analytics') return <CostAnalytics />
        if (view === 'checklist') return <ProductionChecklist />
