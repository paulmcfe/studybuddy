            ...
            <div className="w-full max-w-md space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        disabled={disabled}
                        className="curriculum-btn w-full py-3 px-4 font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {activeCurriculum ? 'Resume Learning Path' : 'Create Learning Path'}
                    </button>
